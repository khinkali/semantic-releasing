...
def call(String version, String userName, String repository, String accessToken) {
    ...
    sh "curl --data '{\"tag_name\": \"${version}\",\"target_commitish\": \"master\",\"name\": \"${version}\",\"body\": \"${RELEASE_NOTES}\",\"draft\": false,\"prerelease\": false}' https://api.github.com/repos/${userName}/${repository}/releases?access_token=${accessToken}"
}
